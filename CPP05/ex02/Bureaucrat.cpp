...
{
    std::cout << "Default Bureaucratcopy constructor" << std::endl;
...
{
    std::cout << "Value Bureaucrat constructor" << std::endl;
    this->name = name;
    this->grade = grade;
...
std::ostream &operator<<(std::ostream &os, const Bureaucrat &bureaucrat)
{
 ...
 void Bureaucrat::signForm(Form &form) const{
	try {
		...
		std::cout << this->name << " couldn't sign the form " << form.getName() << ", grade too low" << std::endl;
	} catch (Form::GradeTooHighException& e) {
		std::cout << this->name << " couldn't sign the form " << form.getName() << ", grade too high" << std::endl;
	}
 }
